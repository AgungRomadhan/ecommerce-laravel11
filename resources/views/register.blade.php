...
<!--================End Login Box Area =================-->
    ...
    <scriptsrc="{{ asset('asset/templates/user/js/vendor/bootstrap.min.js') }}">
    </script>
    ...
    <scriptsrc="https://maps.googleapis.com/maps/api/js?key=AIzaSyCjCGmQ0Uq4exrzdcL6rvxywDDOvfAu6eE"></script>
